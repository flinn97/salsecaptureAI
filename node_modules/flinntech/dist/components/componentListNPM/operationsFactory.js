...
var _operationsObserver = _interopRequireDefault(require("./operationsObserver"));
...
var OperationsFactory = exports["default"] = /*#__PURE__*/function () {
  function OperationsFactory(componentListInterface) {
    _classCallCheck(this, OperationsFactory);
    /**
    ...
    _defineProperty(this, "operationsObserver", void 0);
    _binder.binder.bind(this); // Bind context to all methods.
    ...
    this.operationsObserver = new _operationsObserver["default"](); // Observer for operations.
  }
   ...
   */
  return _createClass(OperationsFactory, [{
    key: "removeFromList",
    value: function removeFromList(comp) {
      this.add = this.add.filter(function (obj) {
        return obj !== comp;
      });
    }
    ...
    key: "getOperationsObserver",
    value: function getOperationsObserver() {
    ...
    key: "setOperationsObserver",
    value: function setOperationsObserver(o) {
    ...
    value: function subscribeToOperations(f, clean) {
      if (clean) {
    ...
    value: function runOperations() {
      var _this$operationsObser;
      (_this$operationsObser = this.operationsObserver).run.apply(_this$operationsObser, arguments);
    }
    ...
    key: "setAddList",
    value: function setAddList(addList) {
      this.add = _toConsumableArray(addList);
      this.lastChange = _toConsumableArray(this.add);
    }
    ...
    */
    ...
    key: "prepare",
    value: (function () {
      var _prepare = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(obj, callback) {
        var prepare, amount, clean, arr, newArr, _iterator, _step, json, comp;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              prepare = obj.prepare, amount = obj.amount, clean = obj.clean;
              amount = amount || 1;
              arr = Array.isArray(prepare) ? prepare : [prepare];
              arr = arr.flatMap(function (json) {
                return Array(amount).fill(json);
              });
            ...
            case 8:
              ...
              json = _step.value;
              _context.next = 12;
              return this.factory.getComponent(_objectSpread({}, json));
            case 12:
              comp = _context.sent;
              newArr.push(comp);
            case 14:
            ...
            case 24:
              ...
              this.setAddList(clean ? _toConsumableArray(arr) : [].concat(_toConsumableArray(this.add), _toConsumableArray(arr)));
              if (callback) {
                callback(this.add);
              }
              if (!obj.run) {
              ...
              _context.next = 30;
              return this.addToComponentList();
            case 30:
              return _context.abrupt("return", this.add);
            case 31:
            case "end":
    ...
    key: "removeFromRegister",
    value: function removeFromRegister(obj) {
      this.setAddList(this.add.filter(function (component) {
    ...
    key: "run",
    value: function run(skipBackendUpdate) {
    ...
    value: function addToComponentList(skipBackendUpdate) {
      var comps = _toConsumableArray(this.add);
      this.clear(); // Clear the `add` list after transferring components.
      this.register(comps, {
        skipBackendUpdate: skipBackendUpdate
