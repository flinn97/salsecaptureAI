...
var Factory = /*#__PURE__*/function () {
  ...
  return _createClass(Factory, [{
    ...
    */
    function registerComponents(register) {
    ...
    key: "setOperationsFactory",
    value: function setOperationsFactory(operationsFactory) {
    ...
    key: "getComponent",
    value: (function () {
      var _getComponent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(obj) {
        var key, comp, nullValues;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              key = obj.type;
              comp = new this.factory[key](this.operationsFactory);
              nullValues = [undefined, "", false];
              if (nullValues.includes(obj._id)) {
                obj._id = comp.getJson()._id;
              }
              comp.setCompState(_objectSpread({}, obj));
