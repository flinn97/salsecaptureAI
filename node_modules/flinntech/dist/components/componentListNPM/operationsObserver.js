 ...
 */
var OperationsObserver = exports["default"] = /*#__PURE__*/function (_BaseObserver) {
  function OperationsObserver() {
    _classCallCheck(this, OperationsObserver);
    return _callSuper(this, OperationsObserver, arguments);
  }
  _inherits(OperationsObserver, _BaseObserver);
  return _createClass(OperationsObserver, [{
    key: "clear",
    value:
    /**
    ...
    key: "cleanSubscibe",
    value: function cleanSubscibe(observerFunction) {
    ...
    value: function run() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (observerFunction) {
            observerFunction.apply(void 0, arguments); // Execute the observer function with arguments.
          }
        }
      } catch (err) {
        _iterator.e(err);
