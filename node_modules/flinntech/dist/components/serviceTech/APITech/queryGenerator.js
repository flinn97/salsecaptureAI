...
exports.QuearyGenerator = void 0;
var _binder = require("../Util/binder");
 ...
 */
var QuearyGenerator = exports.QuearyGenerator = /*#__PURE__*/function () {
   ...
   */
  function QuearyGenerator(db, url) {
    _classCallCheck(this, QuearyGenerator);
    ...
    _defineProperty(this, "orderStr", "date");
    _binder.binder.bind(this); // Binds methods to the class instance
   ...
   * @param {object} db - Firestore database reference.
   */
  return _createClass(QuearyGenerator, [{
    key: "setDB",
    ...
    key: "generateQueary",
    value: (function () {
      var _generateQueary = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(queryJson, path, owner) {
        var whereMap, queryParams, order, queryRef;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              // Maps where conditions into Firestore `where` clauses
              whereMap = queryJson.where.map(function (obj) {
                if (obj.attribute !== undefined) {
                  // Creates a Firestore `where` clause
                  return (0, _firestore.where)(obj.attribute, obj.type || "==", obj.val);
                }
              }).filter(function (obj) {
              ...
              if (owner) {
                whereMap.push((0, _firestore.where)("owner", "==", owner));
              }
              ...
              queryParams = _toConsumableArray(whereMap); // Adds an `orderBy` clause if specified or defaults to the orderStr
              order = queryJson.order || this.orderStr;
              if (order !== "noOrder" && order !== undefined) {
                queryParams.push((0, _firestore.orderBy)(order));
              }

              // Adds a `limit` clause if provided in the queryJson
              if (queryJson.limit) {
                queryParams.push((0, _firestore.limit)(queryJson.limit));
              }

              // Creates and returns the Firestore query
              queryRef = _firestore.query.apply(void 0, [_firestore.collection.apply(void 0, _toConsumableArray(path))].concat(_toConsumableArray(queryParams)));
              return _context.abrupt("return", queryRef);
            case 9:
            case "end":
      ...
      function generateQueary(_x, _x2, _x3) {
        return _generateQueary.apply(this, arguments);
      }
      return generateQueary;
    }())
  }]);
}();