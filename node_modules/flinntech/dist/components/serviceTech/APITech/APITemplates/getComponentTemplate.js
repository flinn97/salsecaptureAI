...
var _urlService = require("../../Util/urlService");
...
var GetComponentTemplate = exports["default"] = /*#__PURE__*/function (_BaseComponent) {
  /**
   ...
   */
  function GetComponentTemplate(props, obj) {
    var _this;
    _classCallCheck(this, GetComponentTemplate);
    _this = _callSuper(this, GetComponentTemplate, [props]);
    _defineProperty(_this, "dispatchItems", {});
    _this.state = _objectSpread(_objectSpread({}, _this.state), {}, {
      type: obj === null || obj === void 0 ? void 0 : obj.type,
      // Type of component
      ids: obj === null || obj === void 0 ? void 0 : obj.ids,
      // IDs to fetch components by
      filterKeys: obj === null || obj === void 0 ? void 0 : obj.filterKeys,
      // Filter keys for component fetching
      path: obj === null || obj === void 0 ? void 0 : obj.path,
      // Path for URL-based fetching
      snapShot: obj === null || obj === void 0 ? void 0 : obj.snapShot,
    ...
    if ((obj === null || obj === void 0 ? void 0 : obj.owner) === false) {
      _this.state.owner = false;
    }
    return _this;
  }
   ...
   */
  _inherits(GetComponentTemplate, _BaseComponent);
  return _createClass(GetComponentTemplate, [{
    key: "getComponentsFromBackend",
    value: (function () {
      var _getComponentsFromBackend = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this$state, type, ids, filterKeys, path, snapShot, owner;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this$state = this.state, type = _this$state.type, ids = _this$state.ids, filterKeys = _this$state.filterKeys, path = _this$state.path, snapShot = _this$state.snapShot, owner = _this$state.owner; // Try to fetch the components from the local list first
              _context.next = 3;
              return this.componentList.getList(type, ids, filterKeys);
            case 3:
              this.compList = _context.sent;
      ...
      function getComponentsFromBackend() {
    ...
    key: "getComponentsAgain",
    value: (function () {
      var _getComponentsAgain = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(props, state) {
      ...
      function getComponentsAgain(_x, _x2) {
        return _getComponentsAgain.apply(this, arguments);
      }
      return getComponentsAgain;
    }()
    /**
    ...
    key: "getFromURL",
    value: (function () {
      var _getFromURL = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              // Retrieve the type and ID from the URL
              this.urlType = _urlService.urlService.getTypeFromURL();
              this.urlId = _urlService.urlService.getIdFromURL();
            case 2:
            case "end":
