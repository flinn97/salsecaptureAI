...
var _getComponentTemplate = _interopRequireDefault(require("./getComponentTemplate"));
...
var GetComponentsFromUrl = exports["default"] = /*#__PURE__*/function (_GetComponentTemplate) {
  function GetComponentsFromUrl() {
    _classCallCheck(this, GetComponentsFromUrl);
    return _callSuper(this, GetComponentsFromUrl, arguments);
  }
  _inherits(GetComponentsFromUrl, _GetComponentTemplate);
  return _createClass(GetComponentsFromUrl, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.next = 7;
              return this.getAssociatedItems();
            case 7:
    ...
    value: (function () {
      var _getFirstComponent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(urlType, urlId) {
        var type, id;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              // Use provided URL type and ID, or fallback to default class properties
              type = urlType || this.urlType;
              id = urlId || this.urlId; // Try to get the component from the local list using the type and ID
      ...
      function getFirstComponent(_x, _x2) {
        return _getFirstComponent.apply(this, arguments);
      }
    ...
    value: (function () {
      var _getAssociatedItems = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return this.comp.getAssociatedItems(this.state.itemTypes);
            case 2:
              this.compList = _context3.sent;
              ...
              _context3.next = 6;
              return this.comp.getAssociatedItemsFromBackend(this.state.itemTypes);
            case 6:
              this.compList = _context3.sent;
              _context3.next = 9;
              return this.setCurrentItems();
            case 9:
            case "end":
    ...
    key: "setCurrentItems",
    value: function setCurrentItems() {
      // Dispatch an action to update the current component and its associated data in the state
      this.dispatch(_objectSpread(_defineProperty({
        currentComponent: this.comp
      }, "current" + this.getCapitalFirstLetter(this.comp.getJson().type), this.comp), this.dispatchItems));
    }
    ...
    key: "setGotComponents",
    value: function setGotComponents() {
