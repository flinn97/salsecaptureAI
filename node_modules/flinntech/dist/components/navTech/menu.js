...
var Menu = /*#__PURE__*/function (_BaseComponent) {
  ...
  function Menu(props) {
    ...
    _this = _callSuper(this, Menu, [props]); // Calls the parent constructor
    _this.state = {
  ...
  return _createClass(Menu, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              // Calls the `open` function passed as prop and waits for the result
              if (this.props.type === "topBar") {
                // Only toggles if the type is "topBar"
                if (!this.state.renderComp) {
                  this.setState({
                    renderComp: component
                  }); // If no component is rendered, set the new component
                } else {
                  this.setState({
                    renderComp: undefined
                  }); // If a component is already rendered, hide it
                }
              }
            case 4:
            case "end":
    ...
    value: function render() {
      var app = this.props.app; // Retrieves the `app` prop, though it's not used in the render method
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        onClick: this.open,
        className: this.props.menuClass ? this.props.menuClass : this.state.defaultStyle
      }, this.props.menuContent && /*#__PURE__*/React.createElement(React.Fragment, null, this.props.menuContent), " "), this.state.renderComp && /*#__PURE__*/React.createElement(React.Fragment, null, this.state.renderComp));
    }
  }]);
