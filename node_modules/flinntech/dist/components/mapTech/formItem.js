...
//model
var FormItem = exports["default"] = /*#__PURE__*/function (_BaseClass) {
  function FormItem(props) {
    _classCallCheck(this, FormItem);
    return _callSuper(this, FormItem, [props]);
  }
  /**
   * create forms in the map though a cutom item usually works better
   * TODO figure out how to make this work better.
   */
  _inherits(FormItem, _BaseClass);
  return _createClass(FormItem, [{
    key: "getOption",
    value: function getOption() {
      /*#__PURE__*/React.createElement(_FormComponentsInterface.ParentFormComponent, _extends({}, this.cell, this.props));
    }
  }]);
}(_baseClass["default"]);