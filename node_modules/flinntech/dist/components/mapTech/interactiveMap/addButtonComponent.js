 ...
 */
var AddComponentButton = exports["default"] = /*#__PURE__*/function (_BaseClass) {
  /**
   * Initializes the AddComponentButton with the provided props.
   * @param {Object} props - The properties passed to the component.
   */
  function AddComponentButton(props) {
    _classCallCheck(this, AddComponentButton);
    return _callSuper(this, AddComponentButton, [props]); // Calls the parent class constructor
  }
   ...
   */
  _inherits(AddComponentButton, _BaseClass);
  return _createClass(AddComponentButton, [{
    key: "preSetup",
    ...
    key: "createObjType",
    value: (function () {
      var _createObjType = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var opps, type;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              opps = this.operationsFactory; // Accesses the operations factory
              type = this.props.addType; // Gets the type of the object to add from props
              _context.next = 4;
              return opps.prepare({
                prepare: _objectSpread({
                  type: type,
                  mapId: this.props.mapId
                }, this.props.addPinProps),
      ...
      function createObjType() {
        return _createObjType.apply(this, arguments);
      }
    ...
    value: function getHtml() {
      var text = this.props.text || "+ Add Item"; // Sets the text of the button (default: "+ Add Item")
