...
var AttributeItem = exports["default"] = /*#__PURE__*/function (_BaseClass) {
  function AttributeItem(props) {
    var _this;
    _classCallCheck(this, AttributeItem);
    _this = _callSuper(this, AttributeItem, [props]);
   ...
   */
  _inherits(AttributeItem, _BaseClass);
  return _createClass(AttributeItem, [{
    key: "getName",
