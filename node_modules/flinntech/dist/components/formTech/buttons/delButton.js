...
var DelButton = exports["default"] = /*#__PURE__*/function (_BaseButton) {
  function DelButton(props) {
    var _this;
    _classCallCheck(this, DelButton);
    _this = _callSuper(this, DelButton, [props]);
    _this.state.formClass = "FCDefaultDelButton";
    _this.content = "Delete";
    return _this;
  }
   ...
   */
  _inherits(DelButton, _BaseButton);
