 ...
 */
var UploadButtonBaseClass = exports["default"] = /*#__PURE__*/function (_BaseButton) {
  /**
   * Initializes the UploadButtonBaseClass instance.
   * @param {Object} props - Properties passed to the upload button component.
   */
  function UploadButtonBaseClass(props) {
    _classCallCheck(this, UploadButtonBaseClass);
    return _callSuper(this, UploadButtonBaseClass, [props]);
  }
   ...
   */
  _inherits(UploadButtonBaseClass, _BaseButton);
  return _createClass(UploadButtonBaseClass, [{
    key: "createFileInfo",
    value: function createFileInfo(event) {
      var currentDate = new Date();
      var month = (currentDate.getMonth() + 1).toString().padStart(2, '0');
      var day = currentDate.getDate().toString().padStart(2, '0');
      var newDay = "".concat(Math.floor(Math.random() * 9999), "-").concat(month + day);
      var path = "images/" + newDay + event.target.files[0].name;
      this.fileInfo = {
        selectedFile: event.target.files[0],
        path: path,
        pic: URL.createObjectURL(event.target.files[0]) // Generate preview URL for the file.
      };
      this.setState(_objectSpread({}, this.fileInfo));
    ...
    key: "prepareOnChange",
    value: (function () {
      var _prepareOnChange = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var obj;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.operationsFactory.prepare({
                prepare: _objectSpread({}, this.props.prepareOnChange),
                clean: true
              });
            case 2:
              obj = _context.sent;
      ...
      function prepareOnChange() {
        return _prepareOnChange.apply(this, arguments);
      }
      return prepareOnChange;
    }()
    /**
    ...
    key: "changeHandler",
    value: (function () {
      var _changeHandler = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
        var pic, _this$obj, _iterator, _step, comp;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.createFileInfo(event);
            case 2:
            ...
            case 5:
              ...
              _context2.next = 8;
              return this.props.callBackFunc(this.obj, this.fileInfo);
            case 8:
              _context2.next = 10;
              return this.APIService.uploadPics(this.fileInfo.selectedFile, this.fileInfo.path);
            case 10:
              ...
              _context2.next = 13;
              return this.APIService.downloadPics(this.fileInfo.path);
            case 13:
              pic = _context2.sent;
              ...
              if (!((_this$obj = this.obj) !== null && _this$obj !== void 0 && _this$obj.length)) {
                _context2.next = 35;
                break;
              }
              // Update the state of each object in the array.
              _iterator = _createForOfIteratorHelper(this.obj);
              _context2.prev = 17;
              _iterator.s();
            case 19:
              ...
              comp = _step.value;
              _context2.next = 23;
              return comp.setCompState(_defineProperty({}, this.props.uploadAttribute || "picURL", pic));
            case 23:
              _context2.next = 19;
              break;
            case 25:
            ...
            case 35:
              _context2.next = 37;
              return this.obj.setCompState(_defineProperty({}, this.props.uploadAttribute || "picURL", pic));
            case 37:
            ...
            case 38:
              ...
              return _context2.abrupt("return", pic);
            case 40:
            case "end":
              return _context2.stop();
          }
        }, _callee2, this, [[17, 27, 30, 33]]);
      }));
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.operationsFactory.addToComponentList();
            case 3:
              _context3.next = 5;
    ...
    value: function getInnerContent() {
      var formContent = this.getFormHtml();
      this.innerContent = [this.label.getHtml({
        content: formContent,
        type: "label"
    ...
    value: function getFormHtml() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: this.props.containerStyle || "defaultButton"
