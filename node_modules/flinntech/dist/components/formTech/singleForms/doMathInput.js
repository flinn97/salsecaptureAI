...
var _mathService = require("../../serviceTech/Util/mathService");
 ...
 */
var DoMathInput = exports["default"] = /*#__PURE__*/function (_InputBaseClass) {
  /**
   * Initializes the DoMathInput instance.
   * @param {Object} props - Properties passed to the input component.
   */
  function DoMathInput(props) {
    _classCallCheck(this, DoMathInput);
    return _callSuper(this, DoMathInput, [props]);
  }
   ...
   */
  _inherits(DoMathInput, _InputBaseClass);
  return _createClass(DoMathInput, [{
    ...
    key: "doMath",
    value: (function () {
      var _doMath = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        var obj, math;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              obj = this.obj[0];
              _context.next = 4;
              return _mathService.mathService.doMath(this.state.val).toString();
            case 4:
              math = _context.sent;
              _context.next = 7;
              return obj.setCompState(_defineProperty({}, this.props.name, math));
            case 7:
              obj.update();
              _context.next = 10;
      ...
      function doMath(_x) {
        return _doMath.apply(this, arguments);
      }
      return doMath;
    }())
  }]);
