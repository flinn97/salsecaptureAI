          ...
          <div className="row after-billing-summary">
            ...
            <div className="col col-left cross-start actions">
              ...
              <div className="row row-left charge-light-btn mb-1">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="1rem" viewBox="0 -960 960 960" width="1rem" fill="#1d4b3e"><path d="M400-80 0-480l400-400 71 71-329 329 329 329-71 71Z"/></svg>
