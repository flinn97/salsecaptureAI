     ...
     />
         ...
         <div style={{padding:"10px", paddingBottom:"100px", height:"100%"}} className={this.props.pageClass||this.state.defaultClass}>
             ...
             <div className="contact-Add-container">
                 ...
                 <div className="row">
                     <div>Subject</div>
                     <div style={{width:"70%", marginLeft:"7px"}}> {/*Container for the subject input*/}
                         <ParentFormComponent obj={obj} name="subject"inPopup={true} /> {/*Component for subject input*/}
                     </div>
                 </div>
                 ...
                 <div className="row">
                     ...
                     <div style={{width:"90%", marginLeft:"10px"}}> {/*Container for the AI Prompt input*/}
                         <ParentFormComponent obj={obj} type="quill" name="body" inPopup={true}/> {/*Component for AI Prompt input (using Quill editor)*/}
                     </div>
                 </div>
