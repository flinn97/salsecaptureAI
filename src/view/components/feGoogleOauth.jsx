...
class GmailAuthButton extends BaseComponent {
    ...
    handleAuthClick = () => {
        ...
        //production
        const CLIENT_ID =  '786362911238-d791o73310fdj13i49c0jejut4g21ci9.apps.googleusercontent.com'
        ...
        const REDIRECT_URI = 'https://viridianauthentication-dleyjvnyfa-uc.a.run.app/oauth2callback'; // Replace with your deployed function URL + /oauth2callback
